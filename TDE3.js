...
// ANDERSON: ESTE CÓDIGO NÃO SERIA NECESSÁRIO O USO DE UM BIAS?
...
// ANDERSON: NA CAMADA OCULTA NÃO DEVERIA TER 1 OU 2 PARA CADA NEURÔNIO DE ENTRADA?
...
// Treinando a rede
// ANDERSON: POR QUE TANTAS ITERAÇÕES DE TREINAMENTO?
...
redeneural = new RedeNeural(3);

let resultadoTeste = ["Pessoa Física", " Empresa"]
let resultado1 = redeneural.feedforward([0,0,0]) 
console.log("Este Cadastro é " + resultadoTeste[resultado1])
//ANDERSON: ESTE TESTE FUNCIONÁRIA? O RESULTADO AQUI TERIA QUE SER "Este Cadastro é Pessoa Física"